...
class SmartCreatureRNA:
    def __init__(self):
        self.input_size = 11  # grad(2) + whiskers(4) + probe stats(5)
        self.hidden_size = 14
        self.output_size = 3
...
def run_learning_creature(best_bits):
    ...
    while True:
        ...
        for i, w_val in enumerate(sensors[2:6]):
...
def run():
    print("Evoluindo criatura única com máscara leve...")
